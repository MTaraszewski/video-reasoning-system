...
help:  ## [any] show this list
	...
	@printf "    \033[35m3.\033[0m local  make s3-push S3_BUCKET=<bucket>    stage clips to your own bucket\n"
	...
	@printf "    \033[32m5.\033[0m gpu    make pull                         pre-pull the server image (multi-GB)\n"
	@printf "    \033[32m6.\033[0m gpu    make s3-pull S3_BUCKET=<bucket>    fetch clips (same region: seconds)\n"
	@printf "    \033[32m7.\033[0m gpu    make serve-bg                     start the model, block until ready\n"
	@printf "    \033[32m8.\033[0m gpu    make probe            \033[31m[planned]\033[0m  CAN the model ground events in time?\n"
	@printf "    \033[32m9.\033[0m gpu    make eval             \033[31m[planned]\033[0m  the measured run\n"
	@printf "   \033[32m10.\033[0m gpu    make down                         stop containers before you stop paying\n\n"
	@printf "  \033[31m[planned]\033[0m steps are not implemented yet and will fail if run.\n\n"
	@printf "  \033[2mSteps 5 and 6 are worth doing before you need them: the image and the\n"
	@printf "  weights are multi-GB, and a metered box should not idle on a download.\033[0m\n\n"
